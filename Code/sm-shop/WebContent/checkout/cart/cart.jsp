...
<table id="controls" width="100%" border="0">
			...
			<td align="right">
						...
						<a href="#" id="recalculateCart" style="float:right;">
							<div class="href-button">
								<span class="button1-box1"></span>
								<span class="button1-box2a"><s:text name="label.invoice.button.recalculate" /></span>
...
<fieldset>
		...
		<a href="#" id="postItems">
			<div class="href-button-checkout">
				<span class="button1-box1"></span>
				<span class="button1-box2a"><s:text name="label.checkout" /></span>
				<span class="button1-box3"></span>
			</div>
		</a>
