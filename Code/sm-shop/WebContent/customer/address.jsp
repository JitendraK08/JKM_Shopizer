			...
			<label class="formlabel" for="submit">&nbsp;
									...
									<a href="javascript:validate();" class="submit">
										<div class="href-button">
											...
											<span class="button1-box2a"><s:text name="label.generic.modify" /></span>
...
//var field8 = new LiveValidation( 'zones', {validMessage: " ",onlyOnSubmit: true } ); 
//field8.add( Validate.Presence,{failureMessage:'<s:text name="messages.required.stateprovince"/>'}); 
