	...
	jQuery(document).ready(function(){ 
		jQuery("a[rel^='prettyPhoto']").prettyPhoto(); 
					...
					<div class="section">
							...
							<div class="section-header"><font class="section-header-1stword"><s:text name="catalog.product" /></font> <s:text name="catalog.productdetails" /></div> 
							...
							<sm-core:contents merchantId="${sessionScope.STORE.merchantId}" sectionId="100" />
				</div><!-- section -->
										...
										<div class="line-8px">
											...
											<div class="button-right">
												<a href="<sm:url scheme="http" value="/product/${productDescription.url}" />">
													<div class="href-button">
														<span class="button1-box1"></span>
														<span class="button1-box2a"><s:text name="catalog.productdetails" /></span>
														<span class="button1-box3"></span>
													</div>
												</a>
											</div>
					...
					<div>
					<sm-core:contents merchantId="${sessionScope.STORE.merchantId}" sectionId="71" />
					</div>
