...
This package contains Shopizer v. 1.1.1
...
Check the first 15 lines of the file, check the server and the port, point to the absolute path of your image 
deployment (*.filefolder)
