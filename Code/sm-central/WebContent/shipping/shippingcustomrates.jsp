...
<head>
    ...
    <title><s:text name="label.shipping.customrates" /></title>
	  ...
	  <s:include value="../common/header.jsp"/>
        ...
        <div id="content" class="clearfix">
            ...
            <div id="main">
				...
				<p>
                <h2><s:text name="label.shipping.customrates" /></h2>
                <p>
				...
				<td>
					...
					<!-- Prices -->
						...
						<tr>
							...
							<%=CurrencyUtil.displayEditablePriceWithCurrency(textname,5,true,spp.getPrice(),ctx.getCurrency(),"")%>
							</td>
							<td>
