...
<body id="store" onload="check_form()">
...
<div id="page">
        ...
        <div id="content" class="clearfix">
			...
			<p>
                		<fieldset>
                		<legend>
                			<s:text name="label.menu.group.store.information" />
                        </legend>
...
<table class="wwFormTable" id="mainform" >
    ...
    <tr>
		...
		<td><script>DateInput('inBusinessSince', true, 'YYYY-MM-DD','<s:property value="inBusinessSince"/>')</script></td>
    </tr>
    ...
    <s:hidden name="merchantProfile.templateModule" value="%{merchantProfile.templateModule}" />
...
<s:text name="label.storesetup" /><br/>

<s:form name="template" action="saveStoreTemplate" method="post">
	<s:textfield name="templateModule" value="%{templateModule}" label="%{getText('label.store.template')}" size="40" required="true"/>
	<s:submit value="%{getText('button.label.submit')}"/>
</s:form>
