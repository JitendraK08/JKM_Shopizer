...
<head>
    ...
    <title><s:text name="label.invoice.invoicedetails" /></title>
	  ...
	  <s:include value="../common/header.jsp"/>
        ...
        <div id="content" class="clearfix">
            ...
            <div id="main">
                ...
                <fieldset>
                <legend>
                <s:text name="label.invoice.invoicedetails" />
                </legend>
    	...
    	<tr>
    		...
    		<td align="right" valign="top">
    			  <table border="0">
    				...
    				<tr>
    					<td>
    					<s:text name="label.invoice.creationdate" />:
    					</td>
    					<td>
    					<script>DateInput('sdate', true, 'YYYY-MM-DD','<s:property value="sdate"/>')</script>
    					</td>
    				</tr>
    				<tr>
    					<td>
    					<s:text name="label.invoice.duedate" />:
    					</td>
    					<td>
    					<script>DateInput('edate', true, 'YYYY-MM-DD','<s:property value="edate"/>')</script>
    					</td>
    				</tr>
    			</table>
    		</td>
...
<br>
		  ...
		  </div><!-- PROP --><br><%=attributesLink%><!--></td>
		  <td class="quantity">
		  <div id="qmessage-<%=i%>"></div>
		  <input type="text" name="quantity-<%=i%>" value="<%=product.getQuantityText()%>" id="quantity-<%=i%>" maxlength="3" />
	        </td><td class="price"><div id="pmessage-<%=i%>"></div><input type="text" name="price-<%=i%>" value="<%=product.getPriceText()%>" id="price-<%=i%>" size="5" maxlength="5" /></td>
		  <td align="right" class="cost-<%=i%>"><%=product.getCostText()%></td>
	      </tr>
