...
var statesfielddefaultvalue = '<s:property value="deliveryState" />';//The default state value when using a text field <td>LABEL</td><td>FORM FIELD [default value]</td>
...
<body id="editcustomermain" onload="check_form()">
...
<table class="wwFormTable" id="mainform" >
    ...
    <s:select list="#refAction.zonesByCountry" id="states" listKey="zoneId" listValue="zoneName" label="%{getText('label.order.deliverystateprovince')}"
               value="%{deliveryState}" name="customerinformation.deliveryState"/>


    <s:select list="#refAction.countries" id="country" listKey="countryId" listValue="countryName" label="%{getText('label.order.deliverycountry')}"
