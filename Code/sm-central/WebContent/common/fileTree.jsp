...
<%
    ...
    //MerchantStore store = mservice.getMerchantStore(merchantid.intValue());
    ...
    //String mediaFolder = ReferenceUtil.buildBinUri(store) + "/" + dirType + "/" +  merchantid + "/";
...
if (new File(dir).exists()) {
		...
		for (String file : files) {
		    if (!new File(dir, file).isDirectory()) {
				...
				String line = "<li class=\"file ext_" + ext + "\"><a href=\"#\" class=\"screenshot\" rel=\"" + serverUrl + file + "\">" + file + "</a></li>";
				if(isMediaBin) {
					line = "<li class=\"file ext_" + ext + "\"><a href=\"#\" class=\"screenshot\" rel=\"" + serverUrl + file + "\">" + file + "</a><a href=\"#\" onclick=\"javascript:deleteFile('" + dir + file + "');\"><img src=\"" + request.getContextPath() + "/common/img/icon-red.png\"></a></li>";
				}
				out.print(line);
				//System.out.println("**************************************");
