...
<head>
    <%@taglib prefix="s" uri="/struts-tags" %>
    <title><s:text name="label.product.productproperties.title" /></title>
...
<body id="productattributes" onload="setTable()">
...
<div id="page">
        ...
        <div id="content" class="clearfix">
			...
			<p>
                		<fieldset>
                		<legend>
                			<s:text name="label.product.productproperties.title" />
                        </legend>


<table width="100%" bgcolor="#ffffe1">
<tr><td><a href="<%=request.getContextPath()%>/catalog/showcreateproduct.action?product.productId=<s:property value="%{product.productId}"/>"><s:text name="label.product.productdetails" /></a></td></tr>
</table>
<br>
<br>
