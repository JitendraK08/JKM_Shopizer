...
<head>
    ...
    <title><s:text name="label.prodlist.title" /></title>
	  ...
	  <s:include value="../common/header.jsp"/>
        ...
        <div id="content" class="clearfix">
            ...
            <div id="main">
                ...
                <fieldset>
                <legend>
                <s:text name="label.prodlist.title" />
                </legend>
...
<div class="line-10px">
	...
	while(proditerator.hasNext()) {
		...
		<td NOWRAP>
		<%=ProductUtil.formatHTMLProductPrice(request.getLocale(),ctx.getCurrency(),prod, false) %>
		</td>
		...
		<td>
		<a href="<%=request.getContextPath() %>/catalog/showcreateproduct.action?product.productId=<%=prod.getProductId() %>">
