...
<head>
    ...
    <title><s:text name="label.product.productprices.title" /></title>
...
<div id="page">
        ...
        <div id="content" class="clearfix">
			...
			<p>
                		<fieldset>
                		<legend>
                			<s:text name="label.product.productprices.title" />
                        </legend>
...
%>
	<tr bgcolor="<%=trcolor%>">
      ...
      <td>
      	<input type="radio" id="defaultPrice_<%=price.getProductPriceId()%>" name="defaultPrice_<%=price.getProductPriceId()%>" value="<%=price.getProductPriceId()%>" <%=checked%>>
      </td>
