...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title><s:text name="label.system.name" /> - <s:text name="label.storefront.contentpagedetails" /></title>
        ...
        <div id="content" class="clearfix">
            ...
            <div id="main">
				...
				<p>
                		<fieldset>
                		<legend>
                		<s:text name="label.storefront.contentpagedescription" />
                        </legend>



			<s:form name="contentpage" action="savePage" enctype="multipart/form-data" method="post" theme="simple" onsubmit="return check_form(contentpage);">
