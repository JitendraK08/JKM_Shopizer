...
public class StoreAction extends CountrySelectBaseAction {
	...
	public String fetchProfile() throws Exception {
		...
		try {
			...
			this.setTemplateModule(profile.getTemplateModule());
	...
	public String saveTemplateModule() {
		...
		try {
			...
			store.setTemplateModule(templateModule);
			this.setTemplateModule(templateModule);
	...
	public String saveStore() {
		...
		try {
			...
			if (store == null) {
				...
				store.setTemplateModule("decotemplate");
			}
