...
public class StoreFrontPortletsAction extends BaseAction {
	...
	private void preparePortletsPositions() {
		...
		//portletsPositions.put(LabelConstants.LABEL_POSITION_BOTTOM_CATEGORY, l.getText(super.getLocale(),
						//"label.merchantstore.position.bottom.category"));
		//portletsPositions.put(LabelConstants.LABEL_POSITION_BOTTOM_PRODUCTS, l.getText(super.getLocale(),
						//"label.merchantstore.position.bottom.product"));
