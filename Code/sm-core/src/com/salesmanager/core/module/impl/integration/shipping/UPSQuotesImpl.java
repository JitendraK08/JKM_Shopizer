...
public class UPSQuotesImpl implements ShippingQuotesModule {
	...
	public Collection<ShippingOption> getShippingQuote(
		...
		try {
			 ...
			 * <Shipment>
			 * 
			 * <Shipper> <Address> <City>Boucherville</City>
			 * <StateProvinceCode>QC</StateProvinceCode>
			 * <CountryCode>CA</CountryCode> <PostalCode>j4b8j9</PostalCode>
			 * </Address> </Shipper>
			 * 
			 * <ShipTo> <Address> <City>Redwood Shores</City>
			 * <StateProvinceCode>CA</StateProvinceCode>
			 * <CountryCode>US</CountryCode> <PostalCode>94065</PostalCode>
			...
			// @todo shipping date
			// DateCalculator<Calendar> calc =
			// CalendarKitCalculatorsFactory.getDefaultInstance().getDateCalculator(storeCountry.getCountryIsoCode2(),
			// HolidayHandlerType.FORWARD);
			// PeriodCountCalculator<Calendar> calc =
			// CalendarKitCalculatorsFactory.getDefaultInstance().getPeriodCountCalculator();
			// IMMDateCalculator<Calendar> calc =
			// CalendarKitCalculatorsFactory.getDefaultInstance().getIMMDateCalculator();

			// @todo time in transit
