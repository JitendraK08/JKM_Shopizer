...
public class RefCache {
	...
	public static void createCache() {
		...
		try {
			 ...
			 * "from CentralCreditCard c order by c.centralCreditCardPosition asc"
			 * ).list(); if(cc!=null) { Iterator ccit = cc.iterator();
			 * while(ccit.hasNext()) { CentralCreditCard ccd =
			 * (CentralCreditCard)ccit.next();
