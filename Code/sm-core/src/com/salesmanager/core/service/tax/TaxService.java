		...
		while (taxMapIter.hasNext()) {// get each tax class
			...
			if (taxCollection != null) {
				...
				while (i.hasNext()) {
					...
					nValue.setScale(2, BigDecimal.ROUND_HALF_EVEN);
					...
					totalTaxAmount = totalTaxAmount.add(bdValue);
					...
					if (line == null) {
						...
						line.setText(name);
						line.setCost(bdValue);
						line.setCostFormated(CurrencyUtil
								.displayFormatedAmountWithCurrency(bdValue,
										currency));
